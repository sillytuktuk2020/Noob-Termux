...
#        PROJECT: Noob-Termux            #
#        Author: SillyTuktuk           #
#  email: sillytuktuk2020@gmailcom #
#      Welvome here      #
######################################
...
cd Noob-Termux/properties
cp ASCII-Shadow.flf ${PREFIX}/share/figlet

# change dir to home/Noob-Termux
cd $HOME
cd Noob-Termux 
...
echo -e "\e[31m[\e[32m14\e[31m]\e[33m Best-of-Noob-Termux\e[m "
...
echo
echo "[*] Applying Noob-Termux Banner " |lolcat -t
sleep 2
echo
