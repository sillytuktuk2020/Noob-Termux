...
######################################
#        PROJECT: Noob-Termux            #
#        Author: AKSHAY DHAWAN        #
#  email: sillytuktuk2020@gmail.com #
######################################

# Installing the following packages to install Noob-Termux
echo 
echo -e "\e[32m[*]\e[34m Installing Noob-Termux \e[m "
echo
# storage permission
...
echo
echo "             ☆:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::☆" |lolcat -t
echo "                       s c r i p t  b y  SillyTukTuk           " |lolcat -t
echo "             ☆:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::☆" |lolcat -t

sleep 3
echo 
echo
echo "[*] Installing Noob-Termux  " |lolcat
echo
sleep 4
...
tfile="${PREFIX}/bin/uninstall-Noob-Termux"
if [ -f "$tfile" ]
then
rm ${PREFIX}/bin/uninstall-Noob-Termux
else 
echo
fi

# copy uninstall Noob-Termux
chmod +x uninstall-Noob-Termux
cp uninstall-Noob-Termux ${PREFIX}/bin

# chanage dir to home
cd $HOME

# change directory to Noob-Termux
cd Noob-Termux
...
echo 
echo "            ☆:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::☆" |lolcat -t
echo "                            S C R I P T   BY AKSHAY DHAWAN  " |lolcat -t
echo "            ☆:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::☆" |lolcat -t
...
echo "===============================" |lolcat
echo
echo -e "\e[31m[\e[33m01\e[31m]\e[32m best ofNoob-Termux \e[m "
...
if [ $n = 1 ] || [ $n = 01 ]
then
 cd properties/Noob-Termux_colors
...
echo
echo "==========================" |lolcat
echo "    Set Noob-Termux cursor" | lolcat -t
echo "==========================" |lolcat
echo
...
echo -e "\e[36m================================\e[m" 
echo
echo -e "\e[34m[\e[31m*\e[34m] \e[32m Noob-Termux has created a session shortcut\e[m" 
echo 
...
# take action if dir !
cd $HOME
cdNoob-Termux/properties/Noob-Termux_fonts/
...
echo "============================" |lolcat -t
echo
echo -e "\e[31m[\e[32m01\e[31m]\e[32m Best of Noob-Termux " 
...
tput cup 6 30
echo -e "\x1b[93m SILLYTUKTUK \x1b[m"
tput cup 9 0
...
tput cup 15 0
echo -en "\e[93m Are you Follow me on github  (y/n)? \e[m "
read answer

if [ "$answer" != "${answer#[Yy]}" ] ;then
tput cup 17 21
    echo -e "\e[42m Thankyou For Use My Tool \e[m"
else
tput cup 17 23
    echo -e "\e[41m Please give me star \e[m"
fi
tput cup 20 0
figlet -f slant "SillyTuktuk" |lolcat
...
#########################################################################
#                       Noob-Termux                                        #
#  Hacking is not crime , Hacking is a game #
#########################################################################
